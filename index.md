...
venue: "Software Carpentry @ Swedish University of Agricultural Sciences"        # brief name of host site without address (e.g., "Euphoric State University")
...
helper: ["Henna Fabritius", "Samantha Dawson"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
eventbrite: 50692877762          # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
---
